...
public class ConditionallyDeadExplanator extends AbstractAnomalyExplanator<List<Set<Constraint>>> {
    public ConditionallyDeadExplanator(@NonNull FMDebuggingModel debuggingModel, ITestCase assumption) {
