...
//
//    // CHECK FALSE OPTIONAL
//    private void checkFalseOptional() {
...
//
//        for (Map.Entry m : explanations.entrySet()) {
//            String anomaly = (String)m.getKey();
//            ArrayList<String> ex = (ArrayList<String>)m.getValue();
//
//            if (ex.size() > 0) {
//                StringBuilder st = new StringBuilder("\tExplanation(s) for " + anomaly + ":\n");
//                for (String e : ex) {
//                    st.append("\t\t" + e + "\n");
//                }
...
//                                    String anomaly,
//                                    Map<String, ArrayList<String>> explanations) {
//        ArrayList<String> ex = ((ArrayList<String>)explanations.get(anomaly));
...
//        List<List<Constraint>> allDiag = new ArrayList<List<Constraint>>();
//
...
////        printConstraints(model);
//
//        allDiag = FastDiag.calculateAllDiagnoses(diag, c, ac, model, allDiag);
//
////        System.out.println("After calculating all diagnoses----------------");
////        System.out.println(model.getNbCstrs());
////        printConstraints(model);
